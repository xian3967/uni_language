...
;(function ($, window, document, undefined) {
  ...
  $.extend(Plugin.prototype, {
    init: function () {
      ...
      var calendar = $('<div class="c-calendar__box"></div>');
      var header = $('<header>' +
        '<h2 class="month"></h2>' +
    ...
    changeMonth: function (value) {
      ...
      this.buildCalendar(this.currentDate, $(this.element).find('.c-calendar__box'));
      this.updateHeader(this.currentDate, $(this.element).find('.c-calendar__box header'));
    ...
    fillUp: function (x, y) {
      ...
      elem.find('.c-calendar__box').append(filler);
